...
export default Home = () => {
  ...
  return (
    <>
    <ScrollView bg="muted.100"  h="80" _contentContainerStyle={{
      px: "20px",
      mb: "4",
      minW: "72"
    }}>
      ...
      <Stack py={4} justifyContent="space-between" direction="row">
        <Text color="muted.500">Conversations</Text>
        <Text color="primary.300">Last Days</Text>
      </Stack>
      ...
      <Box my={3}>
      <Stack py={4} justifyContent="space-between" direction="row">
        <Text color="muted.500">Chatbot</Text>
        <Text color="primary.300">Last Days</Text>
      </Stack>
...
<IconButton  icon={<InfoOutlineIcon />} borderRadius="full" _icon={{
            ...
            <Stack>
              <Text color="muted.700" fontWeight="semibold">Triggered</Text>
              <Box flexDirection="row" display="flex" justifyContent="flex-start" alignItems="flex-start" color="muted.600">
                <AntDesign name="arrowright" size={24} color="black" /> <Text>0%</Text>
              </Box>
            </Stack>
          </Box>
...
<IconButton  icon={<InfoOutlineIcon />} borderRadius="full" _icon={{
           ...
           <Stack>
             ...
             <Stack>
              <Text color="muted.700" fontWeight="semibold">Reactions</Text>
              <Box flexDirection="row" display="flex" justifyContent="flex-start" alignItems="flex-start" color="muted.600">
                <AntDesign name="arrowright" size={24} color="black" /> <Text>0%</Text>
              </Box>
            </Stack>
...
<IconButton  icon={<InfoOutlineIcon />} borderRadius="full" _icon={{
            ...
            <Stack>
              <Text color="muted.700" fontWeight="semibold">Resolved by Chatbot</Text>
              <Box flexDirection="row" display="flex" justifyContent="flex-start" alignItems="flex-start" color="muted.600">
                <AntDesign name="arrowright" size={24} color="black" /> <Text>0%</Text>
              </Box>
            </Stack>
...
<IconButton  icon={<InfoOutlineIcon />} borderRadius="full" _icon={{
           ...
           <Stack>
             ...
             <Stack>
              <Text color="muted.700" fontWeight="semibold">Escalated to human</Text>
              <Box flexDirection="row" display="flex" justifyContent="flex-start" alignItems="flex-start" color="muted.600">
                <AntDesign name="arrowright" size={24} color="black" /> <Text>0%</Text>
              </Box>
            </Stack>
      ...
      <Box my={3}>
      <Stack py={4} justifyContent="space-between" direction="row">
        <Text color="muted.500">Another section</Text>
        <Text color="primary.300">Last Days</Text>
      </Stack>
       <Stack justifyContent="flex-start"  direction="row">
